...
import 'package:to_do_list_getx/app/widget/icons.dart';
      ...
      child: InkWell(
        ...
        child:  DottedBorder(
          ...
          child: Center(
            ...
            size:10.0.wp, color: Colors.grey,
            )
          ),
        ),
      ),
